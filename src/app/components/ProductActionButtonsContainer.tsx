...
function ProductActionButtonsContainer({ productIdParam }: any) {
    ...
    return (
        <div className="flex gap-3">
            <button className="flex  text-white bg-blue-900 border-0 py-2 px-6 focus:outline-none hover:bg-blue-700 rounded" onClick={() => dispatch(addToCart({ productId: productIdParam, size: size, color: color}))}>Add to cart</button>
