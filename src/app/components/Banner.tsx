...
import banner1 from "@/app/assets/banner/banner.jpg"
import banner2 from "@/app/assets/banner/banner1.jpg"
...
function Banner() {
    return (
        <div style={{maxWidth: "1600px", width: "100%", height: "500px", margin: "0 auto"}}>
