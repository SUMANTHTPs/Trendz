...
import { addToCart, clearCart, removeFromCart } from "@/redux/features/cartSlice";
...
export default function Product({ params }: ProductProps) {
    ...
    // const { addTo } = useAppSelector((store) => store.CartReducer)
                ...
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex mt-5">
                            ...
                            <button className="flex ml-3 text-white bg-blue-900 border-0 py-2 px-6 focus:outline-none hover:bg-blue-700 rounded" onClick={checkServiceability}>Check</button>
                        </div>
                        {serviceable && (
