                ...
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex">
                            ...
                            <button className="flex ml-auto text-white bg-blue-900 border-0 py-2 px-6 focus:outline-none hover:bg-blue-700 rounded">Add to cart</button>
                        ...
                        <div className="flex mt-2">
                            <input className="border border-grey-100 px-3 rounded-md" type="text" placeholder="Enter an Indian pin-code" value={pinCode} onChange={(e) => setPinCode(e.target.value)} />
                            <button className="flex ml-3 text-white bg-blue-900 border-0 py-2 px-6 focus:outline-none hover:bg-blue-700 rounded" onClick={checkServiceability}>Check Availability</button>
                        </div>
                        {serviceable && (
